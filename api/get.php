<?php
    ...
    $Subactual_link = "ace4u.online";
    if(!preg_match("/$Subactual_link/",$_SERVER['HTTP_HOST'])) {
        echo "You're not authorised to use this Panel - Purchase via AppSolutions - Telegram https://t.me/apkrebrands";
        die();
     }
